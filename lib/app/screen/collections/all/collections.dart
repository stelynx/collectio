...
import '../../../bloc/app_configuration/app_configuration_bloc.dart';
...
import '../../shared/collectio_loading_screen.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AppConfigurationBloc, AppConfigurationState>(
      builder: (BuildContext context, AppConfigurationState state) {
        if (state is InitialAppConfigurationState) {
          return CollectioLoadingScreen(
            message: Constants.loadingConfiguration,
          );
        }
